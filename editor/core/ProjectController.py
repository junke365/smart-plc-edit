...
from editor.gui.editors.FileManagementPanel import FileManagementPanel
from editor.gui.editors.ProjectNodeEditor import ProjectNodeEditor
from editor.gui.editors.IECCodeViewer import IECCodeViewer
from editor.gui.editors.DebugViewer import DebugViewer, REFRESH_PERIOD

from editor.gui.dialogs.UriEditor import UriEditor
from editor.gui.dialogs.IDManager import IDManager
...
class ProjectController(ConfigTreeNode, PLCControler):
    ...
    def GetIECProgramsAndVariables(self):
        ...
        """
        if self._VariablesList is None:
            try:
                ...
                # *** first section was useless and is now ignored ***
