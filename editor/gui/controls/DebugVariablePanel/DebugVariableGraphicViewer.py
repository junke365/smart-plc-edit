...
from editor.gui.editors.DebugViewer import REFRESH_PERIOD
from editor.gui.controls.DebugVariablePanel.DebugVariableViewer import *
from editor.gui.controls.DebugVariablePanel.GraphButton import GraphButton
