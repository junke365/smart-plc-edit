...
from editor.plcopen.structures import ST_BLOCK_START_KEYWORDS, IEC_BLOCK_START_KEYWORDS, LOCATIONDATATYPES
from editor.gui.editors.EditorPanel import EditorPanel
from editor.gui.controls.CustomStyledTextCtrl import CustomStyledTextCtrl, faces, GetCursorPos
